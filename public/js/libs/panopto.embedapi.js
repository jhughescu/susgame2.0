...
var LoginShownMessage = "iframeLoginShown",
    ...
    EmbedApi = function () {
        ...
        return e.prototype.buildQueryString = function (e) {
            ...
            this.iframe = document.createElement("iframe"), this.iframe.src = n, this.iframe.height = this.height, this.iframe.width = this.width, this.iframe.allow = "autoplay; fullscreen", this.iframe.frameBorder = "0", this.iframeContainer.appendChild(this.iframe), window.addEventListener("message", (function (e) {
                var o, n, i, a, s, r;
                try {
                    var d = e.data,
                        u = JSON.parse(d);
